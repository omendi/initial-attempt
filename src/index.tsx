...
import { InitialAttemptProps, InitialAttempt } from "./initial-attempt";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  return class InitialAttemptBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): InitialAttemptProps {
      const attrs = this.parseAttributes<InitialAttemptProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<InitialAttempt {...this.props} />, container);
    }
